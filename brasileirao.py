...
#pprint(dados2018['equipes']['6']['nome-comum'])
...
def qtos_libertadores(dados):
    faixas_classificacao = dados['fases']['2700']['faixas-classificacao']
    faixa_libertadores = faixas_classificacao['classifica1']['faixa']
    inicio, fim = map(int, faixa_libertadores.split('-'))
    return fim - inicio + 1
'''
...
def ids_dos_melhor_classificados(dados,numero_de_times):
    ...
    ids_melhor_classificados = classificados[:numero_de_times]
    return ids_melhor_classificados
